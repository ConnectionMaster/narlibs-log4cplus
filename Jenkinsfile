                ...
                stage('Unix') {            
                    ...
                    steps {
                        ...
                        fileOperations([
                            ...
                            //,fileRenameOperation(source: 'src/nar/resources/aol/amd64-Linux-gpp/lib/liblog4cplus-2.0.so', destination: 'src/nar/resources/aol/amd64-Linux-gpp/lib/liblog4cplus.so')
                        ])
